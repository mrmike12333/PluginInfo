...
private:
    ...
    juce::Animator m_fadeIn = juce::ValueAnimatorBuilder{}
                                .withOnStartCallback([this](){setVisible(true);})
                                .withEasing(juce::Easings::createEaseIn())
                                .withValueChangedCallback([this](const float value)
                                {
                                    m_alpha = value;
                                    repaint();
                                })
    ...
    juce::Animator m_fullAnimation = juce::AnimatorSetBuilder{m_fadeIn}
