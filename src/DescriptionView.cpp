...
void DescriptionView::setDescription (
...
juce::AttributedString DescriptionView::convertDescriptionToText() const
{
    ...
    const juce::Colour nameColour =
        findColour (juce::Label::ColourIds::textWhenEditingColourId);
    const juce::Colour valueColour =
    ...
    for (int i = 0; i < numAttributes; ++i)
    {
        ...
        const juce::String attributeValue =
            m_description->getAttributeValue (i);
